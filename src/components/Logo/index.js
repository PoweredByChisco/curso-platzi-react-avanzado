...
import { Svg } from '../ListOfPhotoCards/styles'
  ...
  return (
    <Link to='/'>
      <Svg
        ...
        {...props}
      >
        <filter id='prefix__editing-goldstamp'>
          <feFlood floodColor='#797549' result='flood' />
          <feMorphology
            operator='dilate'
            radius={2}
            in='SourceGraphic'
        ...
        <g filter='url(#prefix__editing-goldstamp)'>
          <path
